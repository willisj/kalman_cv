...
def load_gps_trail(extra_fields = False):
    ...
    for line in open('nazeer_trip_400-2100-LF.csv'):        #'nazeer_trip.csv'):
        ...
        if i % 6 == 0:     # Display every sixth entry, plus first and 100th
            ...
            print i,fields, ', Length of line = ', len(fields)
            continue
        elif i == 100:
...
print "Main Line 271 - measurements ", measurements, parse_extra_fields
...
print "Run KF - measurements", measurements
...
print "Run KF - filtered_measurements", filtered_measurements
...
plot_all_dimensions(corrected_positions,"fromFilteredOffset-")
plot_all_dimensions(measurements,"fromMeasurements-")
